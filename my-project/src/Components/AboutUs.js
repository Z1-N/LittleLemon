        ...
        <div className='mt-20 mb-10 bg-slate-900 py-5 ' id='AboutUs'>
            ...
            <div className="grid grid-cols-2 gap-4 m-6 mt-10">
                ...
                <div>
                    ...
                    <p className='font-sans hidden md:block font-bold text-pretty md:text-base leading-relaxed mt-4 text-white'>Little Lemon started in the heart of Dublin in 1987, founded by friends passionate about Mediterranean cuisine. They wanted to create a place where Chicagoans could enjoy authentic Mediterranean flavors from Greece, Italy, Turkey, and Lebanon.
...
Today, Little Lemon thrives, staying true to its roots while embracing new culinary innovations. Join us and experience why Little Lemon is a cherished Chicago destination.</p>
    <p className='font-sans block text-xs md:hidden font-bold text-pretty  mt-2 text-white '>Founded in 1987, Little Lemon brings authentic Mediterranean flavors to Chicago. Named for its fresh, zesty essence, we use the finest ingredients and traditional methods. Our cozy atmosphere and delicious dishes quickly made us a local favorite. Join us to experience why Little Lemon is a beloved Chicago destination.</p>
            </div>
            </div>
        </div>
    );
